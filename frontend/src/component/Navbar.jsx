...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between py-5 font-medium'> 
      <Link to="/">
        <img src={assets.logo} alt="" className='w-24 lg:w-32 cursor-pointer'/>
      </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <img onClick={()=>setVisible(true)} src={assets.menu_icon} alt="" className='w-5 min-w-5 cursor-pointer sm:hidden'/>
      </div>
